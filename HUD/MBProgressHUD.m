...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [[LLModelManger shareInstance] getContentStr:label.text widthSize:totalSize.width heightSize:1000 FontOfSize:label.font];
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    CGSize detailsLabelSize = [[LLModelManger shareInstance] getContentStr:detailsLabel.text widthSize:maxSize.width heightSize:maxSize.height FontOfSize:label.font];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		_progress = 0.f;
		_annular = NO;
        _progressTintColor =[UIColor orangeColor]; //[[UIColor alloc] initWithWhite:1.f alpha:1.f];
